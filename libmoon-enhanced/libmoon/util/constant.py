...
nadir_point_dict = {
    ...
    'dsprites': array([0.45, 0.35]),
    'electricity_demand' : array([0.10, 0.08])
}
...
ideal_point_dict = {
    ...
    'dsprites': array([3.0e-3, 3.40e-1]),
    'electricity_demand' : array([0.005, 0.005])
}
...
def get_hv_ref(problem_name):
    ...
    hv_ref_dict = {
        ...
        'fashion': array([3.0, 3.0]), #previously dont exist
        'regression': array([8.0, 8.0]),
        'credit' : array([2.0, 1.0]),
        'compass' : array([2.0, 2.0]),
        'electricity_demand' : array([2.0, 2.0])
    }
