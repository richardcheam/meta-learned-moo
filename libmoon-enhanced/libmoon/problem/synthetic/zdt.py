...
class ZDT3( BaseMOP ):
    ...
    def get_pf(self, n_pareto_points: int = 100):
        f1 = np.hstack([np.linspace(0, 0.0830, int(n_pareto_points / 5)),
                        np.linspace(0.1822, 0.2578, int(n_pareto_points / 5)),
                        np.linspace(0.4093, 0.4539, int(n_pareto_points / 5)),
                        np.linspace(0.6183, 0.6525, int(n_pareto_points / 5)),
                        np.linspace(0.8233, 0.8518, n_pareto_points - 4 * int(n_pareto_points / 5))])
...
class ZDT4( BaseMOP ):
    ...
    def __init__(self, n_var=10, n_obj=2, lbound=-10*np.ones(10), ubound=10*np.ones(10)):
        lbound[0] = 0
        ubound[0] = 1
